                                            ...
                                            <div id='gallery-2' class='gallery galleryid-32 gallery-columns-3 gallery-size-full file isotope'>
                                                ...
                                                <dl class='gallery-item'>
                                                    <dt class='gallery-icon landscape'>
															<a href='<?= $baseUrl;?>/images/home_hotel2_gallery7.jpg'><img width="1387" height="924" src="<?= $baseUrl;?>/images/home_hotel2_gallery7.jpg" class="attachment-full" alt="home_hotel2_gallery7" /></a>
														</dt>
                                                    <dd></dd>
                                                </dl>
                                                <!-- Gallery item -->
                                                <dl class='gallery-item'>
                                                    <dt class='gallery-icon landscape'>
															<a href='<?= $baseUrl;?>/images/home_hotel2_gallery8.jpg'><img width="693" height="570" src="<?= $baseUrl;?>/images/home_hotel2_gallery8.jpg" class="attachment-full" alt="home_hotel2_gallery8" /></a>
														</dt>
                                                    <dd></dd>
                                                </dl>
                                                <!-- Gallery item -->
                                                <dl class='gallery-item'>
                                                    <dt class='gallery-icon portrait'>
															<a href='<?= $baseUrl;?>/images/home_hotel2_gallery6.jpg'><img width="717" height="1094" src="<?= $baseUrl;?>/images/home_hotel2_gallery6.jpg" class="attachment-full" alt="home_hotel2_gallery6" /></a>
														</dt>
                                                    <dd></dd>
                                                </dl>
                                                <!-- Gallery item -->
                                                ...
                                                <dl class='gallery-item'>
                                                    <dt class='gallery-icon landscape'>
															<a href='<?= $baseUrl;?>/images/home_hotel2_gallery9.jpg'><img width="693" height="570" src="<?= $baseUrl;?>/images/home_hotel2_gallery9.jpg" class="attachment-full" alt="home_hotel2_gallery9" /></a>
														</dt>
                                                    <dd></dd>
                                                </dl>
                                            </div>
